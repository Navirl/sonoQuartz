...
4. **A new extensible [[./configuration]] and [[./configurationPlugins|plugin]] system**: Quartz 3 was hard to configure without technical knowledge of how Hugo's partials worked. Extensions were even hard to make. Quartz 4's configuration and plugin system is designed to be extended by users while making updating to new versions of Quartz easy.
...
- [[./features/folder and tag listings]] have also changed.

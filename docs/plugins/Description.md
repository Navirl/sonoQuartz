...
If the frontmatter contains a `description` property, it is used (see [[../authoring contentSyntax]]). Otherwise, the plugin will do its best to use the first few sentences of the content to reach the target description length.

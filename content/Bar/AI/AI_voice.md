...
データが限られるときに。
なんなら5秒でもできるらしいので、速度が必要ならこっち。感情表現が必要なら[Style-Bert-VITS2](<../../../../Teino/Bar/App/Style-Bert-VITS2.md>)を使用する。
...
また、[sbv2](<../../../../Teino/Bar/App/Style-Bert-VITS2.md>)と比較して世界によく知られているため、ゲームからぶっこ抜いた声が大量に投下されていたりする。
RVCの方が需要があるのでそう多くはない。だってあっちは自分で演技したら済むし。

[Voice Models: Over 27,900+ Unique AI RVC Models](https://voice-models.com)

[Style-Bert-VITS2](<../../../../Teino/Bar/App/Style-Bert-VITS2.md>)
...
[Retrieval-based-Voice-Conversion-WebUI](<../../../../Teino/Bar/App/Retrieval-based-Voice-Conversion-WebUI.md>)
## Beatrice
日本製っぽいRVC。

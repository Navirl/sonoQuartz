...
uvで入れる場合は、`$env:DATA_DIR="C:\open-webui\data"; uvx --python 3.11 open-webui@latest serve`で入る。uvxなのでCに入ることに注意。

[⏱️ Quick Start \| Open WebUI](https://docs.openwebui.com/getting-started/quick-start/#steps)
...
ollamaを使うなら`./public/config/models.json`を操作し、直接モデルを登録する必要がある？

[morphic/docs/CONFIGURATION.md at aca141091812d40689abcae48c0e6de2d95d3601 · miurla/morphic](https://github.com/miurla/morphic/blob/aca141091812d40689abcae48c0e6de2d95d3601/docs/CONFIGURATION.md)
...
## パラメータ
[【図解】 LLMにおけるTemperature・Top-P・Top-Kを簡単に説明｜lonnie](https://note.com/lonnie78932/n/nbd75b7afbc3a)
### Temperature
トークン生成時から多様な単語を生成する。
![1741391781-NGTwurlFV5zskLvH2Ity9f8P.png](https://assets.st-note.com/img/1741391781-NGTwurlFV5zskLvH2Ity9f8P.png?width=1200)
![1741391819-BYAS7tpOHgbxNPMduk8LVaXG.png](https://assets.st-note.com/img/1741391819-BYAS7tpOHgbxNPMduk8LVaXG.png?width=1200)

### Top-P
確率順にした後確率を足していき、合計値が設定値に達するまでを候補に。
![1741392082-8Gd5s7XSAK9cxFLPjoH01ver.png](https://assets.st-note.com/img/1741392082-8Gd5s7XSAK9cxFLPjoH01ver.png?width=1200)

### Top-K
確率順にした後上位K個を選択。
![1741392340-A6vCDx4NHYU10Tl8XgKkGjEJ.png](https://assets.st-note.com/img/1741392340-A6vCDx4NHYU10Tl8XgKkGjEJ.png?width=1200)
...
pはkの改良版という話もあり、pだけある場合も多い。
[TemperatureとTop-pの違い \| インディ・パ \| 生成AI教育・研修・コンサルティング](https://indepa.net/archives/9225)

### 要するに
どれも上げると創造性が、というかランダム性が上がる。
本当に無関係に近い単語を挙げようと思ったらTemperatureの方が有利だという仮説がある。Top-Pだと可能性は低くても関連があるだろうし。

### その他
pは質の低いトークンを切る目的が強いらしい。

pの改良版としてMin-Pというのが考えられている。
最も確率の高いトークンの確率（pmax）が高い場合、モデルはその出力に確信を持っていると言える。
これを元に、確信がある時はPを上げ、ない時は下げるイメージ。品質を挙げつつ多様性を上げる。
[TemperatureとTop-pの違い \| インディ・パ \| 生成AI教育・研修・コンサルティング](https://indepa.net/archives/9225)

一応動的にtemperatureを変更する方法もあるらしい。
[Dynamic Temperature Sampling (for better Creativity & Coherency in Large Language Models)](https://rentry.org/dynamic_temperature)
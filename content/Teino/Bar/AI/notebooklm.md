...
ファイルを取り込み、分析して答えを返してくれる。
シンプルだが取り込み数がなかなかあるので、githubの分析に使える。

[既存のGithubリポジトリの修正にNotebookLMを使用してみた話＠Deforum｜shiba\*2](https://note.com/gentle_murre488/n/nfd7dc86e231b)

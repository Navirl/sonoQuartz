...
解決主義者。問題解決に関係ない余計なことは基本しない。
誰に対しても不遜な口調。口調だけ聞くと騎士団長。ただ名誉やらより問題解決が最優先。

楢名といるときは真顔で波長を合わせて変なことをしているが、これはこうしたほうが楢名のパフォーマンスが上がると知っているため。実際他の人とは変なことは基本しない。

人情が0というわけではないが、理論武装が固められる前提じゃないと人情を出さない。
それ以外で出る人情は大抵打算。人間の恨みの面倒さを知っている。

触れた金属を自在に操れる能力を持つ。
一応誰でも再現可能な技術だが、本編中で再現に成功する人間は誰もいない。

使用中は金属の温度をエネルギーとして使用しているため、動かせば動かすほど金属が冷えていく。
もちろん手が貼りついたりするので実質的な時間制限。触れるときは肌を当てないといけないので手袋不可。

...
これでモバイルアプリを作りたいなら[React Native](<./React Native.md>)や[NativeScript](<./NativeScript.md>)という方法がある。
...
## 画面の更新
コンポーネントに情報を記憶させる。`useState`。[React Native](<./React Native.md#state>)も参照のこと。

...
## UWP
ビルドにwindows10 sdkとroslynコンパイラ、msbuildが必要。roslynはvisual studio付属のwinui applicationワークロードに付属。単体でもインストールできる。なぜかbuild toolにはなかった。

[csharp 用語](<../../CS/csharp 用語.md>)
[csharp メソッド置き換え](../../Info/csharp%20メソッド置き換え.md)
[値型と参照型](<../../CS/値型と参照型.md>)
[boxing](<../../CS/boxing.md>)
[Property](<../../CS/Property.md>)
[privateとstatic](../Teino/privateとstatic.md)
[Indexer](<../../CS/Indexer.md>)
[foreachにおけるインデックス取得法](<../../CS/foreachにおけるインデックス取得法.md>)
[配列の要素数](<../../CS/配列の要素数.md>)
[LINQ](<../../CS/LINQ.md>)
[IEnumerable＜T＞, IEnumerator＜T＞](<../../CS/IEnumerable＜T＞, IEnumerator＜T＞.md>)
[IndexOf](<../../CS/IndexOf.md>)
[？：](<../../CS/？：.md>)
[プリプロセッサ](<../../CS/プリプロセッサ.md>)
[配列、リスト、辞書型速度](<../../CS/配列、リスト、辞書型速度.md>)
[キャストとas](<../../CS/キャストとas.md>)
[Csharp List](<../../CS/Csharp List.md>)
[Covariance, Contravariance, Invariance -ver1](../../CS/Covariance,%20Contravariance,%20Invariance%20-ver1.md)

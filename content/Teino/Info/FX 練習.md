...
[FX練習ソフトおすすめ6選／検証の定番＆無料ソフト【2024年版】 | FXの読み物](https://fx-mono.com/practice-trading-software/)


## Trade Trainer
MT4ハックタイプ。
MTFと複数通貨に対応。スピードは1倍のみ。一応クリック連打で加速は出来る。
[トレードトレーナー　FX検証用ソフト](https://sales.tradetrainer.jp)

## 練習君プレミアム2
MT4ハック。
だいたい上のTTと同じだが、チャートは4枚までしか出せないっぽい？

## Forex Tester 6
テストと言えばの一番有名なツール。独自。
迷ったらこれで何とかなる。1分足以下のTickがほしいなら過去データを有料でDLすることになる。
1時間分しか使えない無料評価版もあるよ。

## [FX Blue Trading Simulator v3 for MT4](https://www.fxblue.com/appstore/39/mt4-trading-simulator)
無料でバックテストできる奴。MT4ハック。
MTFもできるのだが動作が重い。ティックでやったりMTF4枚セットしたりすると動かなくなる。
